...
function Bedroom(props) {
    ...
    const getUsers = async () => {
        let res = await fetchUser('/products/4/ProductType');
        // let res = await fetchUser('http://localhost:8686/products/4/ProductType');
        setTimeout(() => setProducts(res.data), 1000);
    };

    const listbedroom = products.slice(indeOfFirstProduct, indexOfLastProduct);
